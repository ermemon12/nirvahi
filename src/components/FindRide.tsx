...
// import { ArrowLeft, Filter, MapPin, Sparkles, Star, Clock, Users, Shield, CheckCircle2, IndianRupee } from 'lucide-react';
...
//       try {
//         const res = await fetch('http://localhost:5000/api/rides'); // backend API
...
//       ride.from.toLowerCase().includes(fromInput.toLowerCase()) &&
//       ride.to.toLowerCase().includes(toInput.toLowerCase())
//     );
//     setFilteredRides(filtered);
//   }, [fromInput, toInput, rides]);
